                ...
                <table class="table table-striped" id="example1">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center">No Reg Kementan RI</th>
                  ...
                  <tbody>
                    ...
                    foreach ($portfolio as $key => $value) : ?>
                      <tr>
                        ...
                        <td class="text-center"><?= $value->noreg_kementan; ?></td>
                        <?php
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h6 class="modal-title mr-1">Menghapus produk <h6 class="text-center badge badge-danger"><?= $value->judul_portfolio; ?></h6>
          </h6>
