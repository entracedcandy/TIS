<div class="main-sidebar">
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="nav-item">
        <a href="<?= base_url('dashboard'); ?>" class="nav-link <?php if($this->uri->segment(1) == "dashboard") { echo "beep beep-sidebar";} ?>"><i class="fas fa-home"></i> <span>Dashoard</span></a>
      </li>
      <li class="nav-item dropdown">
        <a href="#" class="nav-link has-dropdown"><i class="far fa-user"></i> <span>Pengguna</span></a>
        <ul class="dropdown-menu">
          <li><a class="nav-link  <?php if($this->uri->segment(2) == "profile") { echo "beep beep-sidebar";} ?>" href="<?= base_url('user/profile'); ?>">Profile</a></li>
          <?php if ($user['role_id'] == 1) : ?>
            <li><a class="nav-link  <?php if($this->uri->segment(2) == "daftar_user") { echo "beep beep-sidebar";} ?>" href="<?= base_url('user/daftar_user'); ?>">Daftar Pengguna</a></li>
          <?php endif; ?>
        </ul>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu">
          <?php if ($user['role_id'] == 1) : ?>
            <li><a class="nav-link <?php if($this->uri->segment(2) == "tambahstaff") { echo "beep beep-sidebar";} ?>" href="<?= base_url('staff/tambahstaff'); ?>">Tambah Staff</a></li>
          <?php endif; ?>
          <li><a href="<?= base_url('staff'); ?>" class="nav-link <?php if($this->uri->segment(1) == "staff" && $this->uri->segment(2) == "") { echo "beep beep-sidebar";} ?>" href="<?= base_url('staff/tambahstaff'); ?>">Daftar Staff</a></li>
        </ul>
      </li>
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu">
          <?php if ($user['role_id'] == 1) : ?>
            <li><a class="nav-link <?php if($this->uri->segment(2) == "tambahclient") { echo "beep beep-sidebar";} ?>" href="<?= base_url('client/tambahclient'); ?>">Menambah Client</a></li>
          <?php endif; ?>
          <li><a class="nav-link <?php if($this->uri->segment(1) == "client" && $this->uri->segment(2) == "") { echo "beep beep-sidebar";} ?>" href="<?= base_url('client'); ?>">Daftar Client</a></li>
        </ul>
      </li>
      <li class="nav-item dropdown">
        <a href="#" class="nav-link has-dropdown"><i class="fas fa-briefcase"></i> <span>Produk</span></a>
        <ul class="dropdown-menu">
          <li><a class="nav-link <?php if($this->uri->segment(1) == "portofolio" && $this->uri->segment(2) == "tambah") { echo "beep beep-sidebar";} ?>" href="<?= base_url('portfolio/tambah'); ?>">Menambah Produk</a></li>
          <li><a class="nav-link <?php if($this->uri->segment(1) == "portofolio" && $this->uri->segment(2) == "") { echo "beep beep-sidebar";} ?>" href="<?= base_url('portfolio'); ?>">Daftar Produk</a></li>
        </ul>
      </li>
