...
class Profile extends CI_Controller {
	...
	public function index(){
		...
		$data['group_user'] = $this->session->userdata('group_user');
	...
	function send_wa($to, $pesan){
        // URL API
        $url = "https://cpipga.com/API_WA/inputPesan";
        
        // Data yang akan dikirim (ubah sesuai kebutuhan Anda)
        $data = [
            "to" => $to,
			"msg" => $pesan,
			"is_group" => 0,
        ...
        $headers = [
            ...
            "Token: HEkUJoTGZuSxmafBF5Is3o96saNLFK" // Ganti dengan token Anda
            // "Token: $token" // Ganti dengan token Anda
        ];
        ...
        curl_setopt($ch, CURLOPT_POSTFIELDS, json_encode($data)); // Konversi data menjadi JSON
