...
class ArsipDataMaster extends CI_Controller {
	...
	public function index()
	{
		...
		$id_menu = "183";
		$level_access_pass = $this->arsipms->getLevel($group_user, $id_menu)->result();
		...
		// var_dump($level_access);

		$this->load->view('templates/dash_header',$data);
		$this->load->view('templates/dash_sidebar',$data);
		$this->load->view('page_view/arsipDataMaster');
	}
