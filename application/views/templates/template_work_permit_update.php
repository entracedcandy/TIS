    ...
    <div class="container">
                        ...
                        <table class="form-table" style="margin-top:5px;">
                            ...
                            <tr>
                                ...
                                <td style="width:50%;">
                                    <table class="table-hidden">
                                        <tr>
                                            <td style="text-align: center; width:50%;"><img src="<?= base_url(); ?>asset/img/<?php echo (isset($approval['approval_7_1'])) ? (($approval['approval_1_1']) ? "signature.jpg" : "empty.png") : "empty.png" ?>" width="100" height=auto></td>
                                            <td style="text-align: center; width:50%;"><img src="<?= base_url(); ?>asset/img/<?php echo (isset($approval['approval_8_1'])) ? (($approval['approval_1_1']) ? "signature.jpg" : "empty.png") : "empty.png" ?>" width="100" height=auto></td>
                                        </tr>
                                        <tr>
                        ...
                        <table class="table-hidden" style="font-size:9pt;">
                            ...
                            <tr>
                                <td style="text-align: center; width:20%;">
                                    <!-- <img src="<?php // echo base_url(); ?>asset/img/signature.jpg" width="100" height=auto> -->
                                    <img src="<?php if(file_exists('asset/img/sign/sign_' . $pemohon->id_user . '.png')){ echo base_url() . 'asset/img/sign/sign_' . $pemohon->id_user . '.png'; }else{ echo base_url() . 'asset/img/signature.jpg';} ?>" width="100" height=auto>
                                </td>
                                <td style="text-align: center; width:20%;">
                                    <!-- <img src="<?php // echo base_url(); ?>asset/img/signature.jpg" width="100" height=auto> -->
                                    <img src="<?php if(file_exists('asset/img/sign/sign_' . $pemohon->id_user . '.png')){ echo base_url() . 'asset/img/sign/sign_' . $pemohon->id_user . '.png'; }else{ echo base_url() . 'asset/img/signature.jpg';} ?>" width="100" height=auto>
                                ...
                                <td style="text-align: center; width:20%;">
                                    <img src="<?php echo (isset($approval['sign_1_1'])) ? $approval['sign_1_1'] : '' ?>" width="100" height=auto>
                                </td>
                                <td style="text-align: center; width:20%;">
                                    <img src="<?php echo (isset($approval['sign_2_1'])) ? $approval['sign_2_1'] : '' ?>" width="100" height=auto>
                                </td>
                                <td style="text-align: center; width:20%;">
                                    <img src="<?php echo (isset($approval['sign_3_1'])) ? $approval['sign_3_1'] : '' ?>" width="100" height=auto>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                    ...
                                    <table class="table-hidden">
                                        ...
                                        <tr>
                                            <td style="text-align: center;">
                                                <img src="<?php echo (isset($approval['sign_4_1'])) ? $approval['sign_4_1'] : '' ?>" width="100" height=auto>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                <td>
                                    <table class="table-hidden">
                                        ...
                                        <tr>
                                            <td style="text-align: center;">
                                                <img src="<?php echo (isset($approval['sign_5_1'])) ? $approval['sign_5_1'] : '' ?>" width="100" height=auto>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                <td>
                                    <table class="table-hidden">
                                        ...
                                        <tr>
                                            <td style="text-align: center;">
                                                <img src="<?php echo (isset($approval['sign_6_1'])) ? $approval['sign_6_1'] : '' ?>" width="100" height=auto>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                    ...
                    <td>
                        ...
                        <table class="table-hidden">
                            ...
                            <tr>
                                ...
                                <td style="text-align: center; width:20%;">
                                    <img src="<?php echo (isset($approval['sign_1_2'])) ? $approval['sign_1_2'] : '' ?>" width="100" height=auto>
                                </td>
                                <td style="text-align: center; width:20%;">
                                    <img src="<?php echo (isset($approval['sign_2_2'])) ? $approval['sign_2_2'] : '' ?>" width="100" height=auto>
                                </td>
                                <td style="text-align: center; width:20%;">
                                    <img src="<?php echo (isset($approval['sign_3_2'])) ? $approval['sign_3_2'] : '' ?>" width="100" height=auto>
                                </td>
                            </tr>
                            <tr>
                                <td style="text-align: center; width:20%; font-size:9pt;">
                            ...
                            <tr style="padding:0;">
                                <td>
                                    <table class="table-hidden">
                                        ...
                                        <tr>
                                            <td style="text-align: center;">
                                                <img src="<?php echo (isset($approval['sign_4_2'])) ? $approval['sign_4_2'] : '' ?>" width="100" height=auto>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                <td>
                                    <table class="table-hidden">
                                        ...
                                        <tr>
                                            <td style="text-align: center;">
                                                <img src="<?php echo (isset($approval['sign_5_2'])) ? $approval['sign_5_2'] : '' ?>" width="100" height=auto>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                <td>
                                    <table class="table-hidden">
                                        ...
                                        <tr>
                                            <td style="text-align: center;">
                                                <img src="<?php echo (isset($approval['sign_6_2'])) ? $approval['sign_6_2'] : '' ?>" width="100" height=auto>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
        ...
        <?php
            if($answer['ip_81'] || $answer['ip_82'] || $answer['ip_83'] || $answer['ip_84']){
                ...
                <table class="form-table">
                    <tr>
                        <td><p>Lampiran Foto dari Tim Petugas Safety</p></td>
                    </tr>
                    <tr>
