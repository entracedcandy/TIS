        ...
        <div class="container">
            <div class="row vh-100 align-items-center justify-content-center">
                <div class="col-7 d-md-inline d-none text-center">
                    ...
                    <img class="w-75 p-5 sdw-img" src="<?= base_url('assets/');?>image/logo_TIS.jpg">
                </div>
                <div class="col-md-5">
                    <h2 class="text-center mb-3 fw-bold text-white sdw">Welcome to TIS - APPS</h2>
