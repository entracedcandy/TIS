  ...
  <section class="section">
    ...
    <div class="section-body">
      ...
      <p class="section-lead">
        Di halaman ini Anda dapat membuat Produk baru
      </p>
            ...
            <div class="card-body">
              <form method="POST" action="<?= base_url('portfolio/tambah'); ?>" enctype="multipart/form-data">
                <div class="row">
                  ...
                  <div class="form-group col-lg-6 col-sm-12 col-md-12">
                    <label class="">No Reg Kementan RI</label>
                    <input type="text" class="form-control" name="noreg_kementan" autofocus>
                ...
                <div class="form-group">
                  ...
                  <div class="form-floatings">
                    <label for="testimoni">Manfaat</label>
                    <textarea class="form-control" name="testimoni" placeholder="Isi manfaat" id="floatingTextarea2" style="height: 100px; resize: none;" value="<?= set_value('testimoni'); ?>"></textarea>
                    <small class="text-danger "><?= form_error('testimoni') ?></small>
                  </div>

                </div>
                <div class="form-group">
                  <label class="col-form-label ">Detail Produk</label>
                  <div class="">
                    <textarea name="isi" id="portfolio" value="<?= set_value('isi'); ?>">Isi detail produk</textarea>
                    <small class="text-danger "><?= form_error('isi') ?></small>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-form-label ">Komposisi</label>
                  <div class="">
                    <textarea name="komposisi" id="komposisi" value="<?= set_value('komposisi'); ?>">Isi Komposisi</textarea>
                    <small class="text-danger "><?= form_error('komposisi') ?></small>
                  </div>
                </div>
