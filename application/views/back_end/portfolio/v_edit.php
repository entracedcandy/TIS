              ...
              <form method="POST" action="<?= base_url('portfolio/edit/' . $portfolio->id_portfolio); ?>" enctype="multipart/form-data">
                <div class="row">
                  ...
                  <div class="form-group col-lg-6 col-sm-12 col-md-12">
                    ...
                    <input type="text" class="form-control" name="noreg_kementan" autofocus value="<?= $portfolio->noreg_kementan; ?>">
                ...
                <div class="form-group">
                  <div class="form-floatings">
                    ...
                    <input type="text" class="form-control" name="website" autofocus value="<?= $portfolio->website_portfolio ?>" placeholder="www.example.com">
                ...
                <div class="form-group">
                  ...
                  <div class="">
                    <textarea name="komposisi" id="komposisi" value="<?= set_value('komposisi'); ?>"><?= $portfolio->komposisi; ?></textarea>
