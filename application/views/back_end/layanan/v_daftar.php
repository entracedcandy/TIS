                    ...
                    foreach ($layanan as $key => $value) : ?>
                      <tr>
                        ...
                        <?php elseif ($value->status_layanan == "Pending") : ?>
                          <td class="text-center"><span class="badge badge-warning"><?= $value->status_layanan; ?></span></td>
                        <?php elseif ($value->status_layanan == "Product") : ?>
                          <td class="text-center"><span class="badge badge-success"><?= $value->status_layanan; ?></span></td>
                        <?php elseif ($value->status_layanan == "Certified") : ?>
                          <td class="text-center"><span class="badge badge-secondary"><?= $value->status_layanan; ?></span></td>
                        <?php else : ?>
