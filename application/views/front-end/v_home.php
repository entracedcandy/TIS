  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 d-flex flex-column justify-content-center">
        <h1 data-aos="fade-up">CHAROEN POKPHAND INDONESIA - PLANT PREMIX</h1>
        <h2 data-aos="fade-up" data-aos-delay="400">Satu-satunya Plant di CP Group yang memproduksi Premix Mineral, Vitamin & Watersoluble Vitamin.</h2>
      ...
      <div class="col-lg-6 hero-img" data-aos="zoom-out" data-aos-delay="200">
        <img src="<?= base_url(); ?>vendor/front-end/assets/img/premix.jpg" class="img-fluid" alt="">
      </div>
    </div>
  </div>
...
<main id="main">
  ...
  <section id="features" class="features">
    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row feture-tabs" data-aos="fade-up">
        ...
        <div class="col-lg-6">
          <img src="<?= base_url(); ?>vendor/front-end/assets/img/premix-3.jpg" class="img-fluid" alt="">
        </div>
  ...
  <!-- ======= Services Section ======= -->
  <section id="certified" class="services">
    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row gy-4">
        <?php foreach ($layanan as $key => $value) :
          ...
          if ($value->status_layanan == "Certified") : ?>
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
              <div class="service-box blue">
                <div class="post-img"> <img src="<?= base_url('assets/img/layanan/') . $value->gambar_layanan; ?>" alt="" class="img-fluid rounded " style="height: 100px;">
                </div>
                <br>
                <h4><?= $value->judul_layanan; ?></h4>
  ...
  <section id="product" class="portfolio">
    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row" data-aos="fade-up" data-aos-delay="100">
        <div class="col-lg-12 d-flex justify-content-center">
          <ul id="portfolio-flters">
            ...
            <li data-filter=".filter-ws">Water Soluble Vitamin</li>
      ...
      <div class="row gy-4 portfolio-container" data-aos="fade-up" data-aos-delay="200">
              ...
              <div class="portfolio-wrap">
                ...
                <div class="portfolio-info">
                  ...
                  <div class="portfolio-links">
                    ...
                    <a href="<?= base_url('produkdetail/' . $value->slug_portfolio); ?>" title="More Details"><i class="bi bi-link"></i></a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <?php foreach ($portfolio as $key => $value) :
          // strip tags to avoid breaking any html
          if ($value->nama_layanan == "Water Soluble Vitamin" && $value->status_portfolio == "Publish") : ?>
            <div class="col-lg-4 col-md-6 portfolio-item filter-ws">
              <div class="portfolio-wrap">
                <img src="<?= base_url('assets/img/portfolio/') . $value->gambar_portfolio; ?>" class="img-fluid" alt="">
                <div class="portfolio-info">
                  <h4><?= $value->judul_portfolio; ?></h4>
