    ...
    <section class="section">
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            <img src="<?= base_url('assets/img/company/') . $image; ?>" alt="logo" width="80" class="shadow-light mb-5 mt-2">
        ...
        <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom" data-background="<?= base_url() ?>vendor/back-end/assets/img/unsplash/premix-3.jpg">
          <div class="absolute-bottom-left index-2">
            <div class="text-light p-5 pb-2">
              <div class="mb-5 pb-3">
                <h1 class="mb-2 display-4 font-weight-bold"><?= $pesan; ?></h1>
                <h5 class="font-weight-normal text-muted-transparent">Premix Plant East Java, Indonesia</h5>
              </div>
              Photo by <a class="text-light bb" target="_blank">M Idham Fachrurrozi</a> on Camera
            </div>
          </div>
        </div>
      </div>
