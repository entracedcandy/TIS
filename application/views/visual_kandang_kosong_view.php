...
$(document).ready(function() {    
    ...
    try {
        ...
        // Logika untuk mengubah warna bar menjadi transparan jika datanya 0
        ...
        // --- PENTING: Register Plugin DataLabels ---
        ...
        new Chart(ctx, {
            ...
            options: {
                ...
                plugins: {
                    // --- KONFIGURASI DATALABELS (ANGKA DI ATAS BAR) ---
                    datalabels: {
                        display: true, // Aktifkan label
                        align: 'end',  // Posisi teks di ujung atas bar
                        anchor: 'end', // Patokan posisi dari ujung bar
                        offset: -4,     // Jarak sedikit dari batang
                        ...
                        formatter: function(value) {
                            // Jika nilai 0, kembalikan string kosong (jangan tampilkan)
                            if (value === 0 || value === null) {
                                return '';
                            }
                            // Format angka indonesia (contoh: 10.000)
                ...
                scales: {
                    ...
                    y: {
                        beginAtZero: true,
                        // Tambahkan grace (ruang kosong di atas) 10% agar angka label tidak terpotong
                        grace: '10%',
                        title: {
                            display: true,
    ...
    <?php else: ?>
        ...
        document.getElementById('chartKandangKosong').parentElement.innerHTML = 
            '<div class="alert alert-info text-center"><i class="fas fa-info-circle mr-2"></i>Tidak ada data grafik untuk ditampilkan. Silakan pilih tahun dan tipe ternak.</div>';
    <?php endif; ?>
});
</script>