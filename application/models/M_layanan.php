...
class M_layanan extends CI_Model
{
  ...
  public function daftar()
  {
    ...
    $this->premix->join('tb_user', 'tb_user.id_user = tb_layanan.id_user', 'left');
    $this->premix->order_by('id_layanan', 'desc');
  ...
  public function detail($id_layanan)
  {
    ...
    $this->premix->from('tb_layanan');
    $this->premix->join('tb_user', 'tb_user.id_user = tb_layanan.id_user', 'left');
    $this->premix->where('id_layanan', $id_layanan);
  ...
  public function tambah()
  {
    ...
    $this->premix->insert('tb_layanan', $data);
  ...
  {
    $this->premix->where('id_layanan', $data['id_layanan']);
    $this->premix->update('tb_layanan', $data);
  }

  public function hapus($data)
  {
    $this->premix->where('id_layanan', $data['id_layanan']);
    $this->premix->delete('tb_layanan', $data); // FLASH DATA
  ...
  public function read($slug_layanan)
  {
    ...
    $this->premix->select('*');
    $this->premix->from('tb_layanan');
    $this->premix->where('slug_layanan', $slug_layanan);
    return $this->premix->get()->row();
  }
}
